...
export class ScheduleSectionComponent {
  ...
  // NOTE: The second parameter sets an empty array as the default value if nothing is passed...
  onSelect(type: string, assigned: string[] = []) {
    // First we want to create a local state of the current section data within each iteration
